    ...
    return (
        <div className="bg-white dark:bg-gray-900">
            ...
            <div className="container mx-auto py-4 px-4">
                <div className="flex flex-col md:flex-row items-center bg-gray-100 dark:bg-gray-800 rounded-3xl p-5">
                    <div className="w-full md:w-1/2 flex justify-center">
                        <img src="/static/desa.jpg" className="w-full md:w-full h-auto object-contain" alt="Desa Margajaya" />
                    </div>
                    <div className="w-full md:w-1/2 p-1 md:p-4 text-center md:text-left md:ml-4">
                        <h1 className='text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4 mt-1 md:ml-4'>
                        ...
                        <Link to="/sejarah" className="btn btn-primary mt-3">
                            Selengkapnya
                        </Link>
                    </div>
                </div>
                    ...
                    <div className="bg-transparent border-0 p-4">
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="flex justify-center items-center md:w-1/3 mb-4 md:mb-0">
                                <img src="/static/img/logo_majalengka.jpeg" className="w-3/4 h-auto mx-auto rounded-lg" alt="Logo Bangkalan" />
                            </div>
                            <div className="md:w-2/3">
                                <div className="p-4 text-left">
                                    ...
                                    <a href="/sejarah"><button className='btn btn-primary rounded-3'>Profil desa</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
